...
package com.sharedproject_28apr.services.calculator.services;
import com.sharedproject_28apr.services.calculator.*;
...
public class CalculatorService{
	...
	public AddResponse add(  com.sharedproject_28apr.services.calculator.Add parameters )
	          {
 ...
 return calculatorsoap.add(parameters );
	...
	public DivideResponse divide(  com.sharedproject_28apr.services.calculator.Divide parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
 return calculatorsoap.divide(parameters );
	...
	public MultiplyResponse multiply(  com.sharedproject_28apr.services.calculator.Multiply parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
 return calculatorsoap.multiply(parameters );
	...
	public SubtractResponse subtract(  com.sharedproject_28apr.services.calculator.Subtract parameters )
	          {
 	    Calculator calculator = new Calculator();
 CalculatorSoap calculatorsoap = calculator.getCalculatorSoap();
 SoapSettingsResolver.setBindingProperties((BindingProvider)calculatorsoap, soapServiceSettings);
